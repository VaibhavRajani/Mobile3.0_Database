...
class DatabaseHelper {
  ...
  static Future<int> addNote(Project note) async {
    final db = await _getDB();
    return await db.insert("Note", note.toJson(),
        conflictAlgorithm: ConflictAlgorithm.replace);
  }

  static Future<int> updateNote(Project note) async {
    final db = await _getDB();
  ...
  static Future<int> deleteNote(Project note) async {
    final db = await _getDB();
  ...
  static Future<List<Project>?> getAllNotes() async {
    final db = await _getDB();
